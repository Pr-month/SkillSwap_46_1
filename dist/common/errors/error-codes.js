...
exports.exceptionMessages = exports.exceptionCodes = void 0;
exports.isExceptionCode = isExceptionCode;
exports.exceptionCodes = {
    users: {
...
function isExceptionCode(value) {
    return typeof value === 'string' && value in exports.exceptionMessages;
}
